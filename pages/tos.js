  ...
  return (
    <>
      <MetaTags
        ...
        description="Terms of service and legal agreements for using AIModels.fyi"
        socialPreviewTitle="Terms of Service - AIModels.fyi"
        socialPreviewSubtitle="Read our terms of service and usage policies"
      />
      ...
      <Container maxW="4xl" py={5}>
        ...
        <Box mb={5}>
          <Text mb={2}>
            By accessing the website at https://aimodels.fyi, you are agreeing
          ...
          <Text>
            ...
            AIModels.fyi does not warrant or make any representations concerning
          ...
          <Text mb={2}>
            ...
            inability to use the materials on our website, even if AIModels.fyi
            or a AIModels.fyi authorized representative has been notified orally
          ...
          <Text mb={2}>
            ...
            its website at any time without notice. However, AIModels.fyi does
          ...
          <Text mb={2}>
            AIModels.fyi may revise these terms of service for its website at
